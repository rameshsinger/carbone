...
var builder = {
  ...
  assembleXmlParts: function (arrayOfStringPart, sortDepth, builderDictionary) {
    ...
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableColumn" style:family="table-column"><style:table-column-properties style:column-width="1.27cm" style:rel-column-width="5229*"/></style:style>');
