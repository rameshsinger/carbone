...
var worksheetBuilder = require('./WorkSheetBuilder');
var odtXMLBuilder = require('./ODTXmlBuilder');
...
var builder = {
  ...
  assembleXmlParts: function (arrayOfStringPart, sortDepth, builderDictionary) {
    ...
    for (var i = 0; i < arrayOfStringPart.length; i++) {
      ...
      if (!(_hideBlock > 0 && _prevHideBlock === 0)) {
        let locStr = _part.str;
        if (locStr.startsWith("*Image:")) {
          locStr = locStr.replace("*Image:", "");
          _str += '<draw:frame draw:name="img1" svg:width="300.0pt" svg:height="300.0pt"><draw:image xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"> <office:binary-data>'
          _str += locStr
          _str += "</office:binary-data></draw:image></draw:frame>"
        }
        else if (locStr.startsWith("*Table:")) {
          try {
            locStr = locStr.replace("*Table:", "");
            let tableData = JSON.parse(locStr);
            let tableHtml = "</text:p>";
            if(tableData.title){
              tableHtml += '<text:p text:style-name="TableCustom.titleP"><text:span text:style-name="TableCustom.titleText">'+tableData.title+'</text:span><text:span><text:line-break/></text:span></text:p>'
            }
            tableHtml += '<table:table table:name="TableCustom" table:style-name="TableCustom">';
            for (let i = 0; i < tableData.header.length; i++) {
              tableHtml += '<table:table-column table:style-name="TableCustom.column"/>'
            }
            tableHtml += '<table:table-row table:style-name="TableCustom.HeaderRow">'
            for (let i = 0; i < tableData.header.length; i++) {
              tableHtml += '<table:table-cell table:style-name="TableCustom.Header" office:value-type="string"><text:p text:style-name="TableCustom.HeaderP"><text:span text:style-name="TableCustom.HeaderT">' + tableData.header[i] + '</text:span></text:p></table:table-cell>'
            }
            tableHtml += '</table:table-row>'
            for (let i = 0; i < tableData.data.length; i++) {
              tableHtml += '<table:table-row table:style-name="TableCustom.cellRow">'
              for (let j = 0; j < tableData.data[i].length; j++) {
                tableHtml += '<table:table-cell table:style-name="TableCustom.cell" office:value-type="string"><text:p text:style-name="TableCustom.cellP"><text:span text:style-name="TableCustom.cellT">' + tableData.data[i][j] + '</text:span></text:p></table:table-cell>'
              }
              tableHtml += '</table:table-row>'
            }
            tableHtml += '</table:table><text:p>'
            _str += tableHtml;
          } catch (err) {
            console.log("Table generate error=="+err);
          }
        }
        else if (locStr.startsWith("*pageNo:")) {
          _str += "<text:page-number/>";
        }
        else if (locStr.startsWith("*totalPageNo:")) {
          _str += "xxxPAGExxx";
          // _str += "<text:variable-set text:name='snPageCustom' office:string-value='dataxxxx' /><text:variable-get text:name='snPageCustom'/>";
          // _str += "<text:page-count/>";
        }
        else if (locStr.startsWith("*annexLink:")) {
          locStr = locStr.replace("*annexLink:", "");
          let linkData = JSON.parse(locStr);
          _str += '<text:a xlink:type="simple" xlink:href="#'+linkData.id+'" text:style-name="Annex_Internet_20_link" text:visited-style-name="Annex_Visited_20_Internet_20_Link"><text:span text:style-name="Annex_Internet_20_link"><text:span text:style-name="Annex_T36">'+linkData.title+'</text:span></text:span></text:a>';
        }
        else if (locStr.startsWith("*bookmarkRef:")) {
          let bookMarkId = locStr.replace("*bookmarkRef:", "");
          _str += '<text:bookmark-start text:name="'+bookMarkId+'"/><text:span text:style-name="Annex_T36"> </text:span><text:bookmark-end text:name="'+bookMarkId+'"/>';
        }
        else if (locStr.startsWith("*WorksheetTable:")) {
          // _str += ("</text:p>"+worksheetBuilder.getWorksheetXML(locStr)+"<text:p>");
          _str +="</text:span></text:p>"
          _str += worksheetBuilder.getWorksheetXML(locStr);
          _str +="<text:p><text:span>"
        }
        else if (locStr.startsWith("*ImageTextSequence:")) {
          _str += odtXMLBuilder.imageTextSequence(locStr.replace("*ImageTextSequence:", ""));
        }
        else if (locStr.startsWith("*EmiSuccTable:")) {
          _str += "</text:p>";
          _str += odtXMLBuilder.emiSuccTableGen(locStr.replace("*EmiSuccTable:", ""));
          _str += "<text:p>";
        }
        else if (locStr.startsWith("*uncertainTable:")) {
          _str += "</text:p>";
          _str += odtXMLBuilder.uncertainTable(locStr.replace("*uncertainTable:", ""));
          _str += "<text:p>";
        }
        else {
          _str += _part.str;
    ...
    _res = _res.replace('<office:automatic-styles>', '<office:automatic-styles><style:style style:name="TableCustom" style:family="table"> 			<style:table-properties style:width="6.6931in" style:rel-width="100%" fo:margin-left="0.0035in" fo:margin-top="0in" fo:margin-bottom="0in" table:align="left" style:writing-mode="lr-tb"/> 		</style:style> 		<style:style style:name="TableCustom.Header" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:background-color="#d9d9d9" fo:padding-left="0.0694in" fo:padding-right="0.0694in" fo:padding-top="0in" fo:padding-bottom="0in" fo:border="0.5pt solid #000000"><style:background-image/></style:table-cell-properties></style:style> 		<style:style style:name="TableCustom.cell" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:padding-left="0.0694in" fo:padding-right="0.0694in" fo:padding-top="0in" fo:padding-bottom="0in" fo:border="0.5pt solid #000000"/></style:style> 		<style:style style:name="TableCustom.HeaderRow" style:family="table-row"><style:table-row-properties style:row-height="0.4889in" fo:keep-together="auto"/></style:style> 		<style:style style:name="TableCustom.cellRow" style:family="table-row"><style:table-row-properties style:row-height="0.3007in" fo:keep-together="auto"/></style:style> 		<style:style style:name="TableCustom.HeaderP" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0.028in" fo:margin-bottom="0.028in" style:contextual-spacing="false" fo:text-align="center" style:justify-single-word="false" fo:keep-together="always" fo:orphans="0" fo:widows="0"/><style:text-properties officeooo:paragraph-rsid="00216b6b"/></style:style> 		<style:style style:name="TableCustom.HeaderT" style:family="text"><style:text-properties style:use-window-font-color="true" loext:opacity="0%" fo:font-weight="bold" style:font-name-asian="Calibri" style:font-weight-asian="bold" style:font-size-complex="11pt" style:font-weight-complex="bold"/></style:style> 		<style:style style:name="TableCustom.cellP" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0in" fo:margin-bottom="0in" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="0" fo:widows="0"/><style:text-properties officeooo:paragraph-rsid="00216b6b"/></style:style> 		<style:style style:name="TableCustom.cellT" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0.028in" fo:margin-bottom="0.028in" style:contextual-spacing="false" fo:text-align="center" style:justify-single-word="false" fo:keep-together="always" fo:orphans="0" fo:widows="0"/><style:text-properties officeooo:paragraph-rsid="00216b6b"/></style:style> 		<style:style style:name="TableCustom.column" style:family="table-column"><style:table-column-properties style:column-width="1.5556in" style:rel-column-width="15230*"/></style:style> 		<style:style style:name="TableCustom.titleText" style:family="text"><style:text-properties style:use-window-font-color="true" loext:opacity="0%" style:text-underline-style="solid" style:text-underline-width="auto" style:text-underline-color="font-color" fo:font-weight="bold" style:font-weight-asian="bold" style:font-size-complex="11pt"/></style:style><style:style style:name="Annex_Internet_20_link" style:display-name="Annex Internet link" style:family="text" style:parent-style-name="Annex_Default_20_Paragraph_20_Font"></style:style><style:style style:name="Annex_Visited_20_Internet_20_Link" style:display-name="Annex Visited Internet Link" style:family="text" style:parent-style-name="Annex_Default_20_Paragraph_20_Font"><style:text-properties fo:color="#800080" loext:opacity="100%" style:text-underline-style="solid" style:text-underline-width="auto" style:text-underline-color="font-color"/></style:style><style:style style:name="Annex_Default_20_Paragraph_20_Font" style:display-name="Annex Default Paragraph Font" style:family="text"/><style:style style:name="Annex_T36" style:family="text"><style:text-properties fo:font-size="10pt" style:font-size-asian="10pt" fo:color="#3366ff" style:font-size-complex="10pt"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snParagraphTitle" style:family="paragraph" style:parent-style-name="Text">'
    ...
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snBorderTable" style:family="table">'
    +'<style:table-properties style:width="15.76cm" style:rel-width="99%" fo:margin-left="0.009cm" fo:margin-top="0cm" fo:margin-bottom="0cm" table:align="left" style:writing-mode="lr-tb"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableColumn" style:family="table-column"><style:table-column-properties style:column-width="3.14cm" style:rel-column-width="13054*"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableRow" style:family="table-row"><style:table-row-properties style:min-row-height="0.482cm" fo:keep-together="auto"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableTableRowCell" style:family="table-cell">'
    ...
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableCellHeader" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/>'
    +'<style:text-properties style:use-window-font-color="true" loext:opacity="0%" fo:font-weight="bold" style:letter-kerning="false" style:font-weight-asian="bold" style:font-weight-complex="bold"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableCellBody" style:family="paragraph" style:parent-style-name="Standard">'
    ...
    +'<style:text-properties fo:color="#000000" loext:opacity="100%" style:font-name="Arial" fo:font-size="10pt" style:letter-kerning="false" style:font-size-asian="10pt" style:language-asian="zh" style:country-asian="TW" style:font-name-complex="Arial2" style:font-size-complex="10pt"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableCaptionText" style:family="text">'
    ...
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableCaptionPara" style:family="paragraph" style:parent-style-name="caption">'
    +'<style:paragraph-properties fo:text-align="center" style:justify-single-word="false"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snTableHeaderCellStyle" style:family="table-cell">'
    +'<style:table-cell-properties style:vertical-align="middle" fo:background-color="#d8d8d8" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="0.5pt solid #000000" style:writing-mode="lr-tb">'
    +'<style:background-image/></style:table-cell-properties></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snImageCaptionSpan" style:family="text">'
    +'<style:text-properties style:use-window-font-color="true" loext:opacity="0%" fo:font-size="10pt" fo:language="fr" fo:country="FR" style:font-size-asian="10pt" style:font-size-complex="10pt"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTable" style:family="table">'
    ...
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableColumn" style:family="table-column"><style:table-column-properties style:column-width="5.271cm" style:rel-column-width="21692*"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableRow" style:family="table-row"><style:table-row-properties style:min-row-height="0.75cm" fo:keep-together="auto"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableCell" style:family="table-cell">'
    +'<style:table-cell-properties fo:background-color="#d8d8d8" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="1pt solid #000000" style:writing-mode="lr-tb"><style:background-image/>'
    +'</style:table-cell-properties></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableCellHeaderPara" style:family="paragraph" style:parent-style-name="Table_20_Heading">'
    ...
    +'<style:text-properties style:use-window-font-color="true" loext:opacity="0%" fo:font-size="10pt" style:letter-kerning="false" style:font-size-asian="10pt" style:font-size-complex="10pt"/>'
    +'</style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableCellBodyPara" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0.071cm" fo:margin-bottom="0.071cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/>'
    +'<style:text-properties style:use-window-font-color="true" loext:opacity="0%" fo:font-size="10pt" style:letter-kerning="false" style:font-size-asian="10pt" style:font-size-complex="10pt"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableRowBody" style:family="table-row"><style:table-row-properties style:min-row-height="1.672cm" fo:keep-together="auto"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableCellBody" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="1pt solid #000000" style:writing-mode="lr-tb"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableSlCellBody" style:family="paragraph" style:parent-style-name="List_20_Paragraph" style:list-style-name="WWNum16">'
    +'<style:paragraph-properties fo:margin-top="0.071cm" fo:margin-bottom="0.071cm" style:contextual-spacing="true" fo:text-align="start" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties style:use-window-font-color="true" loext:opacity="0%" fo:font-size="10pt" style:letter-kerning="false" style:font-size-asian="10pt" style:font-size-complex="10pt"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableSlColumn" style:family="table-column"><style:table-column-properties style:column-width="1.27cm" style:rel-column-width="5229*"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="snEmiSucTableStatusColumn" style:family="table-column"><style:table-column-properties style:column-width="3.521cm" style:rel-column-width="14494*"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="uncertainDesc" style:family="paragraph" style:parent-style-name="Text"><style:text-properties style:use-window-font-color="true" loext:opacity="0%"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="uncertainDescNonePara" style:family="paragraph" style:parent-style-name="Text"><style:paragraph-properties fo:margin-left="2.50cm" fo:margin-right="0cm" fo:text-indent="0.286cm" style:auto-text-indent="false"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="TableCustom.titleP" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="start" style:justify-single-word="false" fo:keep-with-next="always"/></style:style>');
    //LDC 104 Styles
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE104" style:family="table"><style:table-properties style:width="16.297cm" fo:margin-top="0cm" fo:margin-bottom="0cm" table:align="center" style:writing-mode="lr-tb"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE104.A" style:family="table-column"><style:table-column-properties style:column-width="2.09cm"/></style:style>'
    +'<style:style style:name="LDCTABLE104.B" style:family="table-column"><style:table-column-properties style:column-width="3.649cm"/></style:style>'
    +'<style:style style:name="LDCTABLE104.C" style:family="table-column"><style:table-column-properties style:column-width="3.653cm"/></style:style>'
    +'<style:style style:name="LDCTABLE104.D" style:family="table-column"><style:table-column-properties style:column-width="3.175cm"/></style:style>'
    +'<style:style style:name="LDCTABLE104.E" style:family="table-column"><style:table-column-properties style:column-width="3.729cm"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE104HEADER" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties fo:color="#000000" loext:opacity="100%" fo:font-size="10pt" fo:font-weight="bold" style:letter-kerning="false" style:font-size-asian="10pt" style:language-asian="zh" style:country-asian="TW" style:font-weight-asian="bold" style:font-size-complex="10pt" style:font-weight-complex="bold"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE104BODY" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0.071cm" fo:margin-bottom="0.141cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties fo:color="#000000" loext:opacity="100%" fo:font-size="10pt" style:letter-kerning="false" style:font-size-asian="10pt" style:language-asian="zh" style:country-asian="TW" style:font-size-complex="10pt"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE104BODYCELL" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:background-color="transparent" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="1pt solid #000000" style:writing-mode="lr-tb"><style:background-image/></style:table-cell-properties></style:style>');
    //LDC 105 Styles
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE105" style:family="table"><style:table-properties style:width="19.9cm" fo:margin-top="0cm" fo:margin-bottom="0cm" table:align="center" style:writing-mode="lr-tb"/></style:style>'
    +'<style:style style:name="LDCTABLE105.A" style:family="table-column"><style:table-column-properties style:column-width="2.193cm"/></style:style>'
    +'<style:style style:name="LDCTABLE105.B" style:family="table-column"><style:table-column-properties style:column-width="2.644cm"/></style:style>'
    +'<style:style style:name="LDCTABLE105.C" style:family="table-column"><style:table-column-properties style:column-width="2.96cm"/></style:style>'
    +'<style:style style:name="LDCTABLE105.D" style:family="table-column"><style:table-column-properties style:column-width="3.087cm"/></style:style>'
    +'<style:style style:name="LDCTABLE105.E" style:family="table-column"><style:table-column-properties style:column-width="6.26cm"/></style:style>'
    +'<style:style style:name="LDCTABLE105.F" style:family="table-column"><style:table-column-properties style:column-width="2.757cm"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE105.HEADERCELL" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:background-color="#d9d9d9" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="0.5pt solid #000000" style:writing-mode="lr-tb"><style:background-image/></style:table-cell-properties></style:style>'
    +'<style:style style:name="LDCTABLE105.HEADERPARA" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties fo:color="#000000" loext:opacity="100%" fo:font-weight="bold" style:letter-kerning="false" style:language-asian="zh" style:country-asian="TW" style:font-weight-asian="bold" style:font-size-complex="11pt" style:font-weight-complex="bold"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE105.SUBHEADERCELL" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:background-color="#d8d8d8" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="0.5pt solid #000000" style:writing-mode="lr-tb"><style:background-image/></style:table-cell-properties></style:style>'
    +'<style:style style:name="LDCTABLE105.SUBHEADERPARA" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="start" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties fo:color="#000000" loext:opacity="100%" fo:font-size="10pt" fo:font-weight="bold" style:letter-kerning="false" style:font-size-asian="10pt" style:language-asian="zh" style:country-asian="TW" style:font-weight-asian="bold" style:font-size-complex="10pt" style:font-weight-complex="bold"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE105.BODYCELL" style:family="table-cell"><style:table-cell-properties style:vertical-align="middle" fo:background-color="transparent" fo:padding-left="0.191cm" fo:padding-right="0.191cm" fo:padding-top="0cm" fo:padding-bottom="0cm" fo:border="0.5pt solid #000000" style:writing-mode="lr-tb"><style:background-image/></style:table-cell-properties></style:style>'
    +'<style:style style:name="LDCTABLE105.BODYPARA" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties fo:color="#000000" loext:opacity="100%" fo:font-size="10pt" style:letter-kerning="false" style:font-size-asian="10pt" style:language-asian="zh" style:country-asian="TW" style:font-size-complex="10pt"/></style:style>');
    _res = _res.replace('<office:automatic-styles>','<office:automatic-styles><style:style style:name="LDCTABLE105.DRAWSTYLE" style:family="graphic" style:parent-style-name="Graphics"><style:graphic-properties fo:margin-left="0cm" fo:margin-right="0cm" fo:margin-top="0cm" fo:margin-bottom="0cm" style:vertical-pos="top" style:vertical-rel="baseline" fo:background-color="transparent" draw:fill="none" draw:fill-color="#ffffff" fo:padding="0cm" fo:border="none" style:mirror="none" fo:clip="rect(0cm, 0cm, 0cm, 0cm)" draw:luminance="0%" draw:contrast="0%" draw:red="0%" draw:green="0%" draw:blue="0%" draw:gamma="100%" draw:color-inversion="false" draw:image-opacity="100%" draw:color-mode="standard"/></style:style>'
    +'<style:style style:name="LDCTABLE105.DRAWPARA" style:family="paragraph" style:parent-style-name="Standard"><style:paragraph-properties fo:margin-top="0cm" fo:margin-bottom="0cm" style:contextual-spacing="false" fo:line-height="100%" fo:text-align="center" style:justify-single-word="false" fo:orphans="2" fo:widows="2"/><style:text-properties style:letter-kerning="false"/></style:style>');
